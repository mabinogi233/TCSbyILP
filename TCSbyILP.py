...
if __name__ == "__main__":
    ...
    dict_poit,maxEnd,poitConut,ref_list,maxChildConut = read_xls(r"D:\试验田\DFG-CQU\DFG_格式文件\g1.xls")
    create_ILP(dict_poit,maxEnd,poitConut,ref_list,maxChildConut,jiange=10)